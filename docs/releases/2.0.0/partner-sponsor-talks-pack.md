# ECC v2.0.0 Partner, Sponsor, and Talks Pack

This pack turns the 2.0.0 release surface into outbound-ready copy for sponsors,
...
| Launch proof | 2.0.0 preview pack, video suite, queue-zero audit | Public release package | Final URLs and human approval |
...
I am getting ECC v2.0.0 ready for release review.
...
Release notes: https://github.com/affaan-m/ECC/blob/main/docs/releases/2.0.0/release-notes.md
...
```text
ECC 2.0 is getting close to 2.0.0.
...
```text
ECC v2.0.0 preview pack is ready for final release review.
...
- Repo: <https://github.com/affaan-m/ECC>
- Release notes: <https://github.com/affaan-m/ECC/blob/main/docs/releases/2.0.0/release-notes.md>
- Quickstart: <https://github.com/affaan-m/ECC/blob/main/docs/releases/2.0.0/quickstart.md>
- Sponsor: <https://github.com/sponsors/affaan-m>
