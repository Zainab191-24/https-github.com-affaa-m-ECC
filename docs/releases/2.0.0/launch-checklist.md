...
- verify package, plugin, marketplace, OpenCode, and agent metadata stays at `2.0.0`
- verify `ecc2/Cargo.toml` stays at `0.1.0` for 2.0.0; `ecc2/` remains an alpha control-plane scaffold
