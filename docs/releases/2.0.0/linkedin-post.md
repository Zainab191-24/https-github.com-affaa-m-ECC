# LinkedIn Draft - ECC v2.0.0

ECC v2.0.0 is ready for final release review as the first release-candidate pass at the 2.0 direction.
...
Shai-Hulud/TanStack campaign, 2.0.0 now includes IOC scanning, no-lifecycle CI
installs, advisory-source refresh, npm audit/signature checks, and AI-tool
persistence coverage.

There is still more to harden before GA, especially around packaging, installers, and the `ecc2/` control plane. But 2.0.0 is enough to show the shape clearly.
