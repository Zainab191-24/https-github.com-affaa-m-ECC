# X Thread Draft - ECC v2.0.0

1/ ECC v2.0.0 is the first release-candidate pass at the 2.0 direction.
...
7/ The 2.0.0 surface ships the public pieces:
...
15/ Release notes:
<https://github.com/affaan-m/ECC/blob/main/docs/releases/2.0.0/release-notes.md>

Itô skill pack boundary:
<https://github.com/affaan-m/ECC/blob/main/docs/releases/2.0.0/ito-prediction-market-skill-pack.md>

URL ledger:
<https://github.com/affaan-m/ECC/blob/main/docs/releases/2.0.0/release-url-ledger-2026-05-19.md>
